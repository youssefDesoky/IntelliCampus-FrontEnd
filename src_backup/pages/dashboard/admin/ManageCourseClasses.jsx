    ...
    return (
        <div className="p-0 sm:p-6">
                ...
                <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-xl md:text-2xl font-bold text-text-primary-active-light dark:text-text-primary-active-dark truncate">
                            {course?.courseName || t('manageCourseClasses.course')}
                        </h1>
                        <p className="text-text-secondary-active-light dark:text-text-secondary-active-dark text-xs md:text-sm truncate">
                            {course?.courseCode || ""}{course?.courseCode && course?.departmentName ? t('manageCourseClasses.separator') : ""}{course?.departmentName || ""}{course?.creditHours ? `${t('manageCourseClasses.separator')} ${t('manageCourseClasses.creditHoursLabel', { hours: course.creditHours })}` : ""}
                        </p>
                    </div>
                </div>
            ...
            <Dialog
                ...
                showCloseButton={true}
            >
                {t('manageCourseClasses.deactivateConfirm', { name: course?.courseName, code: course?.courseCode })}
            </Dialog>
        </div>
    );
}
