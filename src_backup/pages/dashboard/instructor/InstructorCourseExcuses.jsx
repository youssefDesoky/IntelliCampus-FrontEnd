...
import { CourseExcusesSkeleton } from "../../../feature/instructor/SkeletonLoader";
            ...
            <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 flex items-center justify-between min-w-0">
                    ...
                    <p className="shrink-0 text-sm text-text-secondary-default-light dark:text-text-secondary-default-dark">
                        {t('excuses.count', { count: excuses.length })}
                        {pendingCount > 0 ? ` (${t('excuses.pendingCount', { count: pendingCount })})` : ""}
                    </p>
                </div>
            </div>
