...
export default function ClassItem({classInfo}) {
    ...
    const title = classInfo?.title || classInfo?.name || t("dashboard.defaultUpcomingClass");
    const time = classInfo?.time || t("dashboard.defaultTime");
    const startsIn = classInfo?.startsIn || t("dashboard.defaultStartsIn");
    const room = classInfo?.room || t("dashboard.defaultRoom");
    const professor = classInfo?.professor || t("dashboard.defaultInstructor");
