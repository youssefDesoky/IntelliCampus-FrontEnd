    ...
    return (
        <div ref={ref} className={`relative ${className}`}>
            ...
            {isOpen && (
                <div
                    role="menu"
                    className={`absolute ${dropdownAlign === "right" ? "end-0 start-auto" : "start-0 end-auto"} sm:start-1/2 sm:end-auto translate-x-0 sm:-translate-x-1/2 top-[calc(100%+8px)] z-20 w-56 rounded-xl border border-border-primary-default-light bg-bg-surface-primary-default-light p-3 shadow-lg dark:border-border-primary-default-dark dark:bg-bg-surface-primary-default-dark`}
                >
