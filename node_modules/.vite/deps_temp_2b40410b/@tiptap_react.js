...
var require_with_selector_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js": ((exports) => {
	(function() {
		...
		var React$1 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore$1 = shim.useSyncExternalStore, useRef$1 = React$1.useRef, useEffect$1 = React$1.useEffect, useMemo$1 = React$1.useMemo, useDebugValue$1 = React$1.useDebugValue;
	...
	*/
	constructor(component, { editor, props = {}, as = "div", className = "" }) {
		...
		*/
		...
		if (this.editor.isInitialized) (0, import_react_dom$1.flushSync)(() => {
			this.render();
		});
		else queueMicrotask(() => {
