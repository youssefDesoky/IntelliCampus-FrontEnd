export default function ToggleViewMode({isVertical=false, isFirstMode, onFirstModeSelect, onSecondModeSelect, firstModeLabel, secondModeLabel, ...props}) {
    ...
    return (
        <div className={`flex ${isVertical ? 'flex-col' : 'flex-row'} items-center gap-1 p-1.5 border rounded-md border-border-primary-active-light bg-bg-surface-primary-default-light dark:border-border-primary-active-dark dark:bg-bg-surface-primary-default-dark`} {...props}>
            <button 
