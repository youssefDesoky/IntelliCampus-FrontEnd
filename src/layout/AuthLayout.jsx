    ...
    return (
        <div className="min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-r/shorter from-bg-surface-primary-default-light dark:from-bg-surface-primary-default-dark to-blue-50 dark:to-blue-950 px-4">
            <div className={`relative grid grid-cols-100 bg-bg-surface-primary-default-light dark:bg-bg-surface-primary-default-dark rounded-2xl shadow-2xl w-full h-full lg:w-3/4 lg:h-[80vh]`}>
                ...
                <div 
                    className={`flex flex-col justify-center bg-bg-surface-primary-default-light dark:bg-bg-surface-primary-default-dark col-span-100 p-6 rounded-2xl lg:rounded-bl-none lg:col-span-55 lg:p-8`}
                    style={!isDesktop ? { backgroundImage: `url('/images/LoginBG-${currTheme}.png')`, backgroundSize: 'cover' } : undefined}
                >
                    <div className="w-full h-[80%] mx-auto bg-bg-surface-secondary-default-light dark:bg-bg-surface-secondary-default-dark border border-border-primary-default-light dark:border-border-primary-default-dark p-6 lg:p-12 rounded-2xl shadow-2xl min-h-125 max-w-125">
