export default function TypingIndicator() {
  ...
  return (
    <div className="flex items-start gap-3 px-2 mt-1">
      <div className={`relative px-4 py-3 rounded-[18px] text-sm leading-relaxed bg-white/6 border border-white/8 flex items-center gap-1 ${isRtl ? 'rounded-tr-md' : 'rounded-tl-md'}`}>
