...
const typeConfig = {
 ...
 border: "border-l-border-danger-default-light dark:border-l-border-danger-default-dark",
 ...
 border: "border-l-border-warning-default-light dark:border-l-border-warning-default-dark",
 ...
 border: "border-l-border-accent-default-light dark:border-l-border-accent-default-dark",
...
export default function AlertCard({ title, description, type = "info", action, actionLink }) {
 ...
 return (
 <div
 className={`group flex items-start gap-4 p-4 rounded-xl border border-border-primary-default-light dark:border-border-primary-default-dark border-l-4 ${config.border} ${config.bg} hover:shadow-md transition-all duration-300`}
