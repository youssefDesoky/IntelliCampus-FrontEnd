...
function StatCard({ icon, value, label, colorClass, delay = 0 }) {
    ...
    return (
        <div
            className="relative flex flex-col items-center justify-center rounded-xl border border-border-primary-default-light dark:border-border-primary-default-dark bg-bg-surface-primary-default-light dark:bg-bg-surface-primary-default-dark p-4 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5"
            style={{ animationDelay: `${delay}ms` }}
        >
            <div
                className={`flex items-center justify-center w-10 h-10 rounded-full mb-2 ${colorClass}`}
            >
                <Icon className="w-5 h-5 text-white" />
            </div>
            <span className="text-2xl font-bold text-text-primary-active-light dark:text-text-primary-active-dark tabular-nums">
                {value}
            </span>
            ...
            <div className="flex flex-col gap-5 w-full">
                ...
                <div className="rounded-2xl border border-border-primary-default-light dark:border-border-primary-default-dark bg-bg-surface-primary-default-light dark:bg-bg-surface-primary-default-dark p-5 sm:p-6">
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div className="sm:hidden w-full h-px bg-border-primary-default-light dark:bg-border-primary-default-dark" />
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                    {deviceType === "desktop" ? (
                        <div className="flex flex-wrap items-center gap-2 p-1 rounded-xl bg-bg-surface-secondary-default-light dark:bg-bg-surface-secondary-default-dark border border-border-primary-default-light dark:border-border-primary-default-dark">
                        ...
                        <SelectBox
                            ...
                            selectedOption={{
                                value: activeFilter,
                                label: filterOptions.find((o) => o.value === activeFilter)
                                    ?.label,
                            }}
                            yPadding="py-2.5"
                        />
