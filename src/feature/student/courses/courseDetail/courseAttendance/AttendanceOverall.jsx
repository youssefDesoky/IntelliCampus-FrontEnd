        ...
        >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
                <div className="rounded-xl bg-bg-fill-secondary-default-light dark:bg-bg-fill-secondary-default-dark px-4 py-3 text-center">
                    <p className="text-xs uppercase tracking-[0.18em] text-text-secondary-light dark:text-text-secondary-dark mb-1">{t('attendance.attended')}</p>
					<p className="text-lg font-semibold text-text-primary-light dark:text-text-primary-dark">{ar(attendedSessions)}</p>
                </div>
                <div className="rounded-xl bg-bg-fill-secondary-default-light dark:bg-bg-fill-secondary-default-dark px-4 py-3 text-center">
                    <p className="text-xs uppercase tracking-[0.18em] text-text-secondary-light dark:text-text-secondary-dark mb-1">{t('attendance.missed')}</p>
					<p className="text-lg font-semibold text-text-primary-light dark:text-text-primary-dark">{ar(missedSessions)}</p>
                </div>
            </div>
