...
import { EllipsisVerticalIcon, FahimIcon, ClockIcon, CalendarIcon, TrashIcon } from "../../../components/ui/icons";

export default function SmartNote({ note }) {
    const paragraphStyles = "text-sm text-text-secondary-default-light dark:text-text-secondary-default-dark";
    ...
    return(
        ...
        >
            {/* <Dialog isOpen={isEditing} variant="warning">
                You are about to edit this smart note.
            </Dialog>
             */}
            {isEditing && <SmartNoteEditor note={note} onClose={() => setIsEditing(false)} /> }
            ...
            <div className="flex justify-between items-start gap-4 relative">
                <div className="flex flex-col gap-2 min-w-0">
                    ...
                    <p className="text-sm text-text-secondary-default-light dark:text-text-secondary-default-dark line-clamp-3">{note.content}</p>
                </div>
                <Button className="relative top-0 right-0" variant="danger">
