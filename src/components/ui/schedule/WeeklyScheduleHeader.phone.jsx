...
// CHANGED: the mobile branch is gone — this component now only renders
// inside the `hidden md:block` wrapper in WeeklySchedule, so there's exactly
// one layout to maintain instead of two kept in sync by hand.
