        ...
        <>
            <Section>
                ...
                <div>
                    <h2>BREAKDOWN</h2>
                    <div>
                        <ProgressBox progress={25} backgroundColor={'bg-yellow-500'}>
                            <div>
                        ...
                        <ProgressBox progress={studentAttendance} backgroundColor={'bg-yellow-500'}>
                            <div>
                                <p>Present</p>
                            </div>
                        ...
                        <ProgressBox progress={2} backgroundColor={'bg-yellow-500'}>
                            <div>
                                <p>Absent</p>
                            </div>
                            <span>{2}</span>
