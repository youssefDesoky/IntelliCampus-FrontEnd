...
export default function SmartNotes({ studentNotes }) {
    const numOfPages = 5;

    return (
        <>
            <PageHeader title="Smart Notes" subtitle="Organize, manage, and enhance your study notes with AI-powered tools">
            ...
            <Section className="mb-6">
                ...
                <div id="smart-notes-pagination" className="flex items-center justify-center gap-4 mt-8">
                    {[...Array(numOfPages)].map((_, index) => (
                        <button 
                            key={index} 
                            className={`px-4 py-2 rounded-md ${
                                index === 0 
                                ? "bg-blue-500 text-white cursor-none" 
                                : "bg-surface-bg-light dark:bg-surface-bg-dark border border-default-border-light dark:border-default-border-dark text-primary-text-light dark:text-primary-text-dark hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                            }`}
                        >
                            {index + 1}
                        </button>
