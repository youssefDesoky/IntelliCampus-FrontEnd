        ...
        posts: [
            {
                ...
                comments: [
                    {
                        id: "CS-201-p1-c1",
                        sender: instructors[2].name,
                        senderId: instructors[2].id,
        ...
        posts: [
            {
                ...
                sender: instructors[3].name,
                senderId: instructors[3].id,
            ...
            },
            {
                ...
                sender: instructors[4].name,
                senderId: instructors[4].id,
    ...
    },
    {
        ...
        posts: [
            ...
            },
            {
                ...
                sender: instructors[5].name,
                senderId: instructors[5].id,
        ...
        posts: [
            {
                ...
                sender: instructors[6].name,
                senderId: instructors[6].id,
        ...
        posts: [
            {
                ...
                sender: instructors[7].name,
                senderId: instructors[7].id,
        ...
        posts: [
            {
                ...
                sender: instructors[8].name,
                senderId: instructors[8].id,
        ...
        posts: [
            {
                ...
                sender: instructors[9].name,
                senderId: instructors[9].id,
        ...
        posts: [
            {
                ...
                sender: instructors[10].name,
                senderId: instructors[10].id,
        ...
        posts: [
            {
                ...
                sender: instructors[11].name,
                senderId: instructors[11].id,
        ...
        posts: [
            {
                ...
                sender: instructors[12].name,
                senderId: instructors[12].id,
    ...
    },
    {
        ...
        posts: [
            ...
            },
            {
                ...
                sender: instructors[1].name,
                senderId: instructors[1].id,
